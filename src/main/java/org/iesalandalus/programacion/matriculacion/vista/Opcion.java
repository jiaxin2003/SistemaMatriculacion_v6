...
public enum Opcion {
    SALIR("0. Salir"),INSERTAR_ALUMNO("1. Insertar alumno"),BUSCAR_ALUMNO("2. Buscar alumno"),BORRAR_ALUMNO("3. Borrar alumno"),MOSTRAR_ALUMNOS("4. Mostrar alumnos"),
    ...
    MOSTRAR_MATRICULAS_ALUMNO("17. Mostrar matriculas alumno"),MOSTRAR_MATRICULAS_CICLO_FORMATIVO("18. Mostrar matriculas por ciclo formativo"), MOSTRAR_MATRICULAS_CURSO_ACADEMICO("19. Mostrar matriculas por curso academico");
